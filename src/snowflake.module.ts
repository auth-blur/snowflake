...
function createSnowflakeProviders(): Array<Provider<SnowflakeService>> {
    ...
    return snowflakes.map(({ type, flags }) =>
        createSnowflakeProvider(flags, type),
    );
}
